...
const Sidebar = () => {
  ...
  return !isMenuOpen ? null : (
    <aside className="text-[17px] w-[19rem] h-[calc(100vh-4rem)] bg-yellow-200 pt-2 px-3 sticky top-[4rem] overflow-y-hidden hover:overflow-y-scroll hover:scrollbar scroll-smooth">
      <div>
        <ul className="flex flex-col">
          <Link className="" to="/">
            <li className="flex px-4 py-[10px] rounded-lg cursor-pointer hover:bg-red-200 ">
              <span className="mr-6 ">
          ...
          <li className="flex px-4 py-[10px] rounded-lg cursor-pointer hover:bg-red-200 hover:text-black h-full">
            <span className="mr-6">
          ...
          <li className="flex px-4 py-[10px] rounded-lg cursor-pointer hover:bg-red-200 hover:text-black">
            <span className="mr-6">
