...
const Sidebar = () => {
  ...
  return !isMenuOpen ? null : (
    <aside className="text-[17px] w-[19rem] h-[calc(100vh-3.6rem)]  pt-2 px-5 sticky top-[3.6rem] overflow-y-hidden hover:overflow-y-scroll hover:scrollbar scroll-smooth">
      <div>
        <ul className="flex flex-col">
          <Link className="" to="/">
            <li className="flex items-center p-2 rounded-lg cursor-pointer hover:bg-red-200  ">
              <span className="mr-6 ">
          ...
          <li className="flex items-center p-2 rounded-lg cursor-pointer hover:bg-red-200 hover:text-black">
            <span className="mr-6">
